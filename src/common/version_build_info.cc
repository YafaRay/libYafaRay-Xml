...
#include "yafaray_xml_version_build_info.h"

namespace yafaray_xml
{

std::string build_info::getVersionString() { return YAFARAY_XML_VERSION_STRING + getGitLine(false); }
std::string build_info::getVersionDescription() { return YAFARAY_XML_VERSION_DESCRIPTION; }
int build_info::getVersionMajor() { return YAFARAY_XML_VERSION_MAJOR; }
int build_info::getVersionMinor() { return YAFARAY_XML_VERSION_MINOR; }
int build_info::getVersionPatch() { return YAFARAY_XML_VERSION_PATCH; }
std::string build_info::getVersionPreRelease() { return YAFARAY_XML_VERSION_PRE_RELEASE; }
std::string build_info::getVersionPreReleaseDescription() { return YAFARAY_XML_VERSION_PRE_RELEASE_DESCRIPTION; }
std::string build_info::getGitDescribe() { return YAFARAY_XML_VERSION_GIT; }
std::string build_info::getGitTag() { return YAFARAY_XML_VERSION_GIT_TAG; }
std::string build_info::getGitBranch() { return YAFARAY_XML_VERSION_GIT_BRANCH; }
std::string build_info::getGitDirty() { return YAFARAY_XML_VERSION_GIT_DIRTY; }
std::string build_info::getGitCommit() { return YAFARAY_XML_VERSION_GIT_COMMIT; }
std::string build_info::getGitCommitDateTime() { return YAFARAY_XML_VERSION_GIT_COMMIT_DATETIME; }
std::string build_info::getCommitsSinceTag() { return YAFARAY_XML_VERSION_GIT_COMMITS_SINCE_TAG; }
std::string build_info::getBuildArchitectureBits() { return YAFARAY_XML_BUILD_ARCHITECTURE_BITS; }
std::string build_info::getBuildCompiler() { return YAFARAY_XML_BUILD_COMPILER; }
std::string build_info::getBuildCompilerVersion() { return YAFARAY_XML_BUILD_COMPILER_VERSION; }
std::string build_info::getBuildOs() { return YAFARAY_XML_BUILD_OS; }
std::string build_info::getBuildType() { return YAFARAY_XML_BUILD_TYPE; }
std::string build_info::getBuildOptions() { return YAFARAY_XML_BUILD_OPTIONS; }
std::string build_info::getBuildFlags() { return YAFARAY_XML_BUILD_FLAGS; }
