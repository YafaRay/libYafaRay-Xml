...
std::string buildinfo::getVersionString() { return YAFARAY_XML_VERSION_STRING + getGitLine(false); }
std::string buildinfo::getVersionDescription() { return YAFARAY_XML_VERSION_DESCRIPTION; }
int buildinfo::getVersionMajor() { return YAFARAY_XML_VERSION_MAJOR; }
int buildinfo::getVersionMinor() { return YAFARAY_XML_VERSION_MINOR; }
int buildinfo::getVersionPatch() { return YAFARAY_XML_VERSION_PATCH; }
std::string buildinfo::getVersionPreRelease() { return YAFARAY_XML_VERSION_PRE_RELEASE; }
std::string buildinfo::getVersionPreReleaseDescription() { return YAFARAY_XML_VERSION_PRE_RELEASE_DESCRIPTION; }
std::string buildinfo::getGitDescribe() { return YAFARAY_XML_VERSION_GIT; }
std::string buildinfo::getGitTag() { return YAFARAY_XML_VERSION_GIT_TAG; }
std::string buildinfo::getGitBranch() { return YAFARAY_XML_VERSION_GIT_BRANCH; }
std::string buildinfo::getGitDirty() { return YAFARAY_XML_VERSION_GIT_DIRTY; }
std::string buildinfo::getGitCommit() { return YAFARAY_XML_VERSION_GIT_COMMIT; }
std::string buildinfo::getGitCommitDateTime() { return YAFARAY_XML_VERSION_GIT_COMMIT_DATETIME; }
std::string buildinfo::getCommitsSinceTag() { return YAFARAY_XML_VERSION_GIT_COMMITS_SINCE_TAG; }
std::string buildinfo::getBuildArchitectureBits() { return YAFARAY_XML_BUILD_ARCHITECTURE_BITS; }
std::string buildinfo::getBuildCompiler() { return YAFARAY_XML_BUILD_COMPILER; }
std::string buildinfo::getBuildCompilerVersion() { return YAFARAY_XML_BUILD_COMPILER_VERSION; }
std::string buildinfo::getBuildOs() { return YAFARAY_XML_BUILD_OS; }
std::string buildinfo::getBuildType() { return YAFARAY_XML_BUILD_TYPE; }
std::string buildinfo::getBuildOptions() { return YAFARAY_XML_BUILD_OPTIONS; }
std::string buildinfo::getBuildFlags() { return YAFARAY_XML_BUILD_FLAGS; }
